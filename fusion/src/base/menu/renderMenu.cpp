...
#include "../moduleManager/modules/combat/blockhit.h"
#include "../moduleManager/modules/world/fastplace.h"
...
void Menu::RenderMenu()
{
	...
	ImVec2 textSize = Menu::FontBold->CalcTextSizeA(28, FLT_MAX, 0.0f, "Bloom");
	float posX = windowPos.x + (columnWidth / 2) - (textSize.x / 2);
	float posY = windowPos.y + 20;

	Menu::GlitchText("Bloom", ImVec2(posX, posY));
	...
	//if (Menu::TabButton("World", (currentTab == 3 ? ImVec4(0.3f, 0.3f, 0.3f, 0.2f) : ImVec4(0.1f, 0.1f, 0.1f, 0.f)))) currentTab = 3;
