...
void Menu::SetupImgui()
{
	...
	//Menu::Font = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\arial.ttf", 16);
	//Menu::FontBold = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\arialbd.ttf", 24); // Arial Bold

	//Menu::Font = io.Fonts->AddFontDefault();
	//Menu::FontBold = Menu::Font;
