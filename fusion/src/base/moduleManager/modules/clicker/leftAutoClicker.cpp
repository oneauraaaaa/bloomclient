...
void LeftAutoClicker::RenderMenu()
{
	...
	if (ImGui::BeginChild("autoclicker", ImVec2(425, 130))) {
		...
		Menu::DoToggleButtonStuff(857835, "Toggle Left Auto Clicker", &LeftAutoClicker::Enabled);
		ImGui::SetCursorPosY(ImGui::GetCursorPosY() + 5);
		ImGui::Separator();
		Menu::DoSliderStuff(3281, "Min CPS", &LeftAutoClicker::leftMinCps, 1, LeftAutoClicker::leftMaxCps);
		Menu::DoSliderStuff(676, "Max CPS", &LeftAutoClicker::leftMaxCps, LeftAutoClicker::leftMinCps, 20);
		Menu::DoToggleButtonStuff(2137, "Ignore Blocks", &LeftAutoClicker::ignoreBlocks);
